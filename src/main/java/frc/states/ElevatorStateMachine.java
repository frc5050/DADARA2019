...
public class ElevatorStateMachine {
    ...
    public static final double SHAFT_DIAMETER = inchesToMeters(1.732);
    ...
    public synchronized ElevatorState update(ElevatorState update) {
        ...
        // If the bottom limit is touched, it sets the offset to the encoder value.
        ...
        // If the bottom limit is touched, it sets the maximum output to 1, minimum output to 0.
        // If the bottom limit is not touched, it sets the maximum output to 1, and the minimum output to -1.
        if (systemState.bottomLimitTouched) {
    ...
    /**
     * Returns the filtered encoder position, which is the raw encoder position with the offset accounted for.
     *
     * @return the encoder position with offset taken into account
     */
